              ...
              {action === "HOLD" && (
                <div style={{ margin: "4px 16px 16px", borderRadius: 14, overflow: "hidden", border: `1.5px solid ${G.bdr}`, background: "#fff" }}>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 0, borderBottom: `1px solid ${G.faint}` }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "12px 14px", borderRight: `1px solid ${G.faint}` }}>
                      <span style={{ fontSize: 22 }}>💰</span>
                      <div>
                        <div style={{ fontSize: 9, color: G.muted, textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 3 }}>{tx("storage")}</div>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "12px 14px" }}>
                      <span style={{ fontSize: 22 }}>🏦</span>
                      <div>
                        <div style={{ fontSize: 9, color: G.muted, textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 3 }}>{tx("loan")}</div>
